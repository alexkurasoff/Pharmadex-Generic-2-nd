...
/**
 * Specific Amendment to replacement IPI
...
@DiscriminatorValue("AmdREPLACEMENT_IPI")
public class AmdREPLACEMENT_IPI extends Amendment {

	private static final long serialVersionUID = -5595568704953839094L;
