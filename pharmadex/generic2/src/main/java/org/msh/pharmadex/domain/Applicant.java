...
public class Applicant extends CreationDetail implements Serializable {
    ...
    @OneToMany(mappedBy = "applicant", cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH, CascadeType.DETACH})
    private List<AgentAgreement> agents;
    
    @OneToMany(mappedBy = "applicant", targetEntity=Amendment.class, cascade = {CascadeType.MERGE, CascadeType.PERSIST, CascadeType.REFRESH, CascadeType.DETACH})
    private List<AmdAPPLICANT> amendment;
    ...
    public List<AgentAgreement> getAgents() {
		return agents;
	}

	public void setAgents(List<AgentAgreement> agents) {
		this.agents = agents;
	}

	public List<AmdAPPLICANT> getAmendment() {
		return amendment;
	}

	public void setAmendment(List<AmdAPPLICANT> amendmentsAppl) {
		this.amendment = amendmentsAppl;
	}
