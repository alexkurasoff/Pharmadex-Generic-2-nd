...
@FacesConverter(value = "dosFormItemConverter")
@Component
@Scope("singleton")
public class DosFormItemConverter implements Converter, Serializable {
	private static final long serialVersionUID = -1386322162463729299L;
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent component, String submittedValue) {
    	...
    	if (submittedValue.trim().equals("")) {
            return form;
            	...
            	form = dosService.findDosFormItemByName(submittedValue, true);
                if(form == null){
