...
public class Workspace extends CreationDetail implements Serializable {
    ...
    private int costHuman;
    
    private int costVeterinary;
	...
	/**
	 * @param costHuman - Human unit cost
	 */
	...
	/**
	 * @param costVeterinary - Veterinary unit cost
	 */
