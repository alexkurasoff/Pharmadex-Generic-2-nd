...
//        regHomeMbean.setShowCompany(false);
	...
	public String getTemplate(boolean isEdit){
		if(isEdit)
			return "/templates/companydetailtmpl.xhtml";
		return "/templates/companydetailtmplShow.xhtml";
	}
    ...
    public String getCompanyTypesString() {
    	String res = "";
    	if(getCompanyTypes() != null && getCompanyTypes().size() > 0){
    		for(String s:getCompanyTypes())
    			res += "<p>" + s + "</p>";
    	}
    	return res;
    }
